...
class MailService
{
    ...
    public function to(string|array $to, ?string $name = null): static { $this->to = is_array($to) ? $to : [$to]; return $this; }
    public function template(string $templateName, array $variables = []): static { $html = view($templateName, $variables)->render(); $this->htmlBody = $html; return $this; }
