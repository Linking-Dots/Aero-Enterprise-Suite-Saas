...
import {
  HStack, VStack, Field, Input, Text, Eyebrow, Box,
} from '@aero/ui';
...
export default function LeaveCalendarIndex({ events, range }) {
  ...
  return (
    <>
      <style>{`
        .lcal-page { padding: 1.5rem; }

        .lcal-header { margin-bottom: 1.5rem; }
        .lcal-title  { font-family: var(--aeos-font-display); font-size: 1.5rem; font-weight: 700; color: var(--aeos-text-primary); }

        .lcal-filters { margin-bottom: 1.5rem; }
      ...
      <div className="lcal-page">
        <div className="lcal-header">
          <div className="lcal-title">Leave Calendar</div>
        </div>

        <div className="lcal-filters">
...
LeaveCalendarIndex.layout = page => <App title="Leave Calendar">{page}</App>;
